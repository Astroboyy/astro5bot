...
cl = LINETCR.LINE() #卂丂ㄒ尺ㄖ乃ㄖㄚ
cl.login(qr=True)
cl.loginResult()

ki = LINETCR.LINE() #卂丂ㄒ尺ㄖ乃ㄖㄚ
ki.login(qr=True)
ki.loginResult()

kk = LINETCR.LINE() #卂丂ㄒ尺ㄖ乃ㄖㄚ
kk.login(qr=True)
kk.loginResult()

kc = LINETCR.LINE() #卂丂ㄒ尺ㄖ乃ㄖㄚ
kc.login(qr=True)
kc.loginResult()

ks = LINETCR.LINE() #卂丂ㄒ尺ㄖ乃ㄖㄚ
ks.login(qr=True)
ks.loginResult()
...
helpMessage ="""a͓̽s͓̽t͓̽r͓̽o͓̽ b͓̽o͓̽t͓̽ t͓̽e͓̽a͓̽m͓̽ p͓̽r͓̽o͓̽t͓̽e͓̽c͓̽t͓̽
Owner : ✰AstroBoy✰
-==================-
◄]·♦·Menu For Public·♦·[►
[•]Adminlist
...
👑Hanya Untuk Owner👑
-==================-
a͓̽s͓̽t͓̽r͓̽o͓̽ b͓̽o͓̽t͓̽ t͓̽e͓̽a͓̽m͓̽ p͓̽r͓̽o͓̽t͓̽e͓̽c͓̽t͓̽
-==================-
"""
KAC=[cl,ki,kk,kc,ks]
...
mid = cl.getProfile().mid #卂丂ㄒ尺ㄖ乃ㄖㄚ
Amid = ki.getProfile().mid #卂丂ㄒ尺ㄖ乃ㄖㄚ
Bmid = kk.getProfile().mid #卂丂ㄒ尺ㄖ乃ㄖㄚ
Cmid = kc.getProfile().mid #卂丂ㄒ尺ㄖ乃ㄖㄚ
Dmid = ks.getProfile().mid #卂丂ㄒ尺ㄖ乃ㄖㄚ
...
Minat? Silahkan PM!
Idline: http://line.me/ti/p/U91TM3tndS""",
    "lang":"JP",
...
def bot(op):
    try:
        ...
        if op.type == 13:
          if wait["Protectcancl"] == True:
            ...
            if op.param2 in admin:
              ...
              random.choice(KAC).sendText(op.param1, "woi Mau Ngundang Siapa loe?\loe Bukan Admin\nJadi Aku Cancel😛")
        ...
        if op.type == 26:
            ...
            elif "卂丂ㄒ尺ㄖ乃ㄖㄚ kick " in msg.text:
              if msg.from_ in admin:
            ...
            elif "卂丂ㄒ尺ㄖ乃ㄖㄚ invite " in msg.text:
              if msg.from_ in admin:
    ...
    #-----------------=Selesai=------------------
              ...
              if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        random.choice(KAC).sendText(msg.to,"Sudah Terbuka boy")
                else:
                    if wait["lang"] == "JP":
            ...
            elif msg.text in ["卂丂ㄒ尺ㄖ乃ㄖㄚ buka qr","卂丂ㄒ尺ㄖ乃ㄖㄚ open qr"]:
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
                    X.preventJoinByTicket = False
                    cl.updateGroup(X)
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Done boy")
                    else:
            ...
            elif msg.text in ["卂丂ㄒ尺ㄖ乃ㄖㄚ open qr","卂丂ㄒ尺ㄖ乃ㄖㄚ buka qr"]:
                if msg.toType == 2:
                    X = kc.getGroup(msg.to)
                    X.preventJoinByTicket = False
                    kc.updateGroup(X)
                    if wait["lang"] == "JP":
                        kc.sendText(msg.to,"Done Astro")
                    else:
              ...
              if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        random.choice(KAC).sendText(msg.to,"Sudah Tertutup boy")
                else:
                    if wait["lang"] == "JP":
                        random.choice(KAC).sendText(msg.to,"Can not be used outside the group")
                    else:
                ...
                cl.sendText(msg.to,"Perintah Ditolak.")
                cl.sendText(msg.to,"Hanya Admin Yang bisa Gunain Perintah ini.")
            elif msg.text in ["卂丂ㄒ尺ㄖ乃ㄖㄚ close qr","卂丂ㄒ尺ㄖ乃ㄖㄚ tutup qr"]:
                if msg.toType == 2:
                    X = ki.getGroup(msg.to)
                    X.preventJoinByTicket = True
                    ki.updateGroup(X)
                    ...
                    if wait["lang"] == "JP":
                        ...
                        ki.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["卂丂ㄒ尺ㄖ乃ㄖㄚ qr","卂丂ㄒ尺ㄖ乃ㄖㄚ close qr"]:
                if msg.toType == 2:
                    X = kk.getGroup(msg.to)
                    X.preventJoinByTicket = True
                    kk.updateGroup(X)
                    if wait["lang"] == "JP":
                        kk.sendText(msg.to,"Done boy")
                    else:
            ...
            elif msg.text in ["卂丂ㄒ尺ㄖ乃ㄖㄚ tutup qr","卂丂ㄒ尺ㄖ乃ㄖㄚ close qr"]:
                if msg.toType == 2:
                    X = kc.getGroup(msg.to)
                    X.preventJoinByTicket = True
                    kc.updateGroup(X)
                    if wait["lang"] == "JP":
                        kc.sendText(msg.to,"Done boy")
                    else:
                ...
                #print wait2
                 ...
                 if msg.from_ in admin:
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "Ketik Cctv dulu Astro\nBaru Ketil Ciduk\nDASAR PIKUN ♪")
#-----------------------------------------------

#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["Kuy","Astro bot","Join kuy"]: #Panggil Semua Bot
              if msg.from_ in owner:
    ...
    for zx in range(0,500):
      ...
      if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
        try:
          ...
          cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉Auto Like by ⭐⭐Astroboy⭐⭐👈\n\n™Sing Voice Generation of indonesia™")
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
            if hasil['result']['posts'][zx]['userInfo']['mid'] in owner:
                try:
                    ...
                    cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto like by ^Astro Bot^\nStatus Boss udah Kami Like\nOwner Kami :\nAstro boy")
                    cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"=====Ready=====\n[★]Bot Protect For Group\n[★]\n[★]Selfbot in Your Account[★]\n- 1 Selfbot 1 Bot Assist\n- 1 Selfbot 2 Bot Assist\n- 1 Selfbot 3 Bot Assist\n- 1 Selfbot 4 Bot Assist\n- 1 Selfbot 5 Bot Assist\n\nMau Coba Atau Test Terlebih Dahulu Bisa\nMinat??? PM Id Line @hanavy1992\nLagu Promo Lho Kak\n===[★]Astroboy Bot Protect[★]===")
                    print "Like"
                except:
                    pass
            else:
                print "Status Sudah di Like boy"
